...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Enque method added person to front of queue, not end.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: GetNextPerson Method fails to check for 0 or negative number 
    ...
    // Defect(s) Found: No defects found- Throwing error on empty Queue properly
